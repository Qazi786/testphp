        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="datetime-local" name="pickup_date_and_time" class="form-control" required="true">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" name="pickup_address" class="form-control" required="true">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" name="dropoff_address" class="form-control" required="true">
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="number" name="height" class="form-control" required="true">
                    <p class="help-block"></p>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="length" class="form-control" required="true">
                    <p class="help-block"></p>
                ...
                <div class="col-md-3">
                   ...
                   <input type="number" name="width" class="form-control" required="true">
                    <p class="help-block"></p>
                    @if($errors->has('width'))
                        <p class="help-block">
                            {{ $errors->first('width') }}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" name="extra_field" class="form-control" required="true">
...
<input type="hidden" name="user_id" class="form-control" required="true" value="{{Auth::user()->id}}">
